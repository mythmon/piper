...
# Import for side affect
from piper.models import budgets, transactions

try:
    from piper.settings.local import DATABASE_URL
except:
    from piper.settings.default import DATABASE_URL
